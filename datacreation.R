...
data <- simcausal::sim(D,n=1000)

cov(data$a_0,data$l_1,use="complete.obs")
cov(data$a_1,data$l_2,use="complete.obs")
cov(data$a_2,data$l_3,use="complete.obs")
cov(data$a_3,data$l_4,use="complete.obs")
# Convert numeric censoring variables to 'censored' variable for ltmle
data$c_0 <- BinaryToCensoring(is.censored=data$c_0)
data$c_1 <- BinaryToCensoring(is.censored=data$c_1)
data$c_2 <- BinaryToCensoring(is.censored=data$c_2)
data$c_3 <- BinaryToCensoring(is.censored=data$c_3)
data$c_4 <- BinaryToCensoring(is.censored=data$c_4)
